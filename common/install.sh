...
headline() {
	cp $FONTDIR/MaLinotta-Black.ttf $SYSFONT/Black.ttf;
	cp $FONTDIR/MaLinotta-BlackItalic.ttf $SYSFONT/BlackItalic.ttf;
	cp $FONTDIR/MaLinotta-Bold.ttf $SYSFONT/Bold.ttf;
	cp $FONTDIR/MaLinotta-BoldItalic.ttf $SYSFONT/BoldItalic.ttf;
	cp $FONTDIR/MaLinotta-Medium.ttf $SYSFONT/Medium.ttf;
	cp $FONTDIR/MaLinotta-MediumItalic.ttf $SYSFONT/MediumItalic.ttf;
	sed -i '/\"sans-serif\">/,/family>/{s/Roboto-M/M/;s/Roboto-B/B/}' $SYSXML
	nsss
}

body() {
	cp $FONTDIR/MaLinotta-Italic.ttf $SYSFONT/Italic.ttf;
	cp $FONTDIR/MaLinotta-Light.ttf $SYSFONT/Light.ttf;
	cp $FONTDIR/MaLinotta-LightItalic.ttf $SYSFONT/LightItalic.ttf;
	cp $FONTDIR/MaLinotta-Regular.ttf $SYSFONT/Regular.ttf;
	cp $FONTDIR/MaLinotta-Thin.ttf $SYSFONT/Thin.ttf
	cp $FONTDIR/MaLinotta-ThinItalic.ttf $SYSFONT/ThinItalic.ttf;
	sed -i '/\"sans-serif\">/,/family>/{s/Roboto-T/T/;s/Roboto-L/L/;s/Roboto-R/R/;s/Roboto-I/I/}' $SYSXML
}

condensed() {
	cp $FONTDIR/MaLinotta-Bold.ttf $SYSFONT/Condensed-Bold.ttf;
	cp $FONTDIR/MaLinotta-BoldItalic.ttf $SYSFONT/Condensed-BoldItalic.ttf;
	cp $FONTDIR/MaLinotta-Italic.ttf $SYSFONT/Condensed-Italic.ttf;
	cp $FONTDIR/MaLinotta-Light.ttf $SYSFONT/Condensed-Light.ttf;
	cp $FONTDIR/MaLinotta-LightItalic.ttf $SYSFONT/Condensed-LightItalic.ttf;
	cp $FONTDIR/MaLinotta-Medium.ttf $SYSFONT/Condensed-Medium.ttf;
	cp $FONTDIR/MaLinotta-MediumItalic.ttf $SYSFONT/Condensed-MediumItalic.ttf;
	cp $FONTDIR/MaLinotta-Regular.ttf $SYSFONT/Condensed-Regular.ttf;
...
nsss() {
	if [ $API -ge 29 ] && i=$(grep NotoSerif $SYSXML) && i=$(grep SourceSansPro $SYSXML); then
		...
		cp $FONTDIR/MaLinotta-BoldItalic.ttf $SYSFONT/NS-BoldItalic.ttf
		cp $FONTDIR/MaLinotta-Bold.ttf $SYSFONT/NS-Bold.ttf		
		cp $FONTDIR/MaLinotta-Italic.ttf $SYSFONT/NS-Italic.ttf
		cp $FONTDIR/MaLinotta-Regular.ttf $SYSFONT/NS-Regular.ttf
		if [ $PART -eq 1 ]; then
			sed -i 's/SourceSansPro-SemiBold/SSP-Medium/;s/SourceSansPro-/SSP-/' $SYSXML			
			cp $FONTDIR/MaLinotta-BoldItalic.ttf $SYSFONT/SSP-BoldItalic.ttf
			cp $FONTDIR/MaLinotta-Bold.ttf $SYSFONT/SSP-Bold.ttf
			cp $FONTDIR/MaLinotta-MediumItalic.ttf $SYSFONT/SSP-MediumItalic.ttf
			cp $FONTDIR/MaLinotta-Medium.ttf $SYSFONT/SSP-Medium.ttf
			cp $FONTDIR/MaLinotta-Italic.ttf $SYSFONT/SSP-Italic.ttf
			cp $FONTDIR/MaLinotta-Regular.ttf $SYSFONT/SSP-Regular.ttf
		fi
	fi
}
...
pixel() {
	...
	if [ ! -z $DEST ]; then
		cp $FONTDIR/MaLinotta-Regular.ttf $DEST/GoogleSans-Regular.ttf
		cp $FONTDIR/MaLinotta-Italic.ttf $DEST/GoogleSans-Italic.ttf
		cp $FONTDIR/MaLinotta-Medium.ttf $DEST/GoogleSans-Medium.ttf
		cp $FONTDIR/MaLinotta-MediumItalic.ttf $DEST/GoogleSans-MediumItalic.ttf
		cp $FONTDIR/MaLinotta-Bold.ttf $DEST/GoogleSans-Bold.ttf
		cp $FONTDIR/MaLinotta-BoldItalic.ttf $DEST/GoogleSans-BoldItalic.ttf
		if [ $BOLD ]; then
...
ui_print " **************************************************************"
ui_print " "                MaLinotta fonts by einzbern
ui_print " "